                ...
                <div className="inner-container mt-[25px] py-9">
                    ...
                    <div className="md:col-span-8 flex flex-col md:flex-row items-center justify-center md:justify-end gap-4 flex-wrap">
                        ...
                        <Link href={href} key={i}>
                            <a className="text-center font-bold hover:underline">{label}</a>
                        </Link>
                        ))}

                        {/* Social Icon */}
                        <Link href="https://linkedin.com/">
                        <a className="p-2 rounded-full bg-white inline-flex items-center justify-center">
                ...
                <div className="inner-container border-t border-[#dfdfdf] mt-[50px] md:mt-[1px] py-9">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-2 text-sm">
                            <Link href="/terms">
                                <a className="hover:underline text-center">Terms of Use</a>
                            </Link>
                        <span className="hidden sm:inline">|</span>
                            <Link href="/policies">
                                <a className="hover:underline text-center">Privacy Policy</a>
                            </Link>
                        </div>
                    </div>
                </div>
