    ...
    <div className="container pt-24 pb-12">
      ...
      */}
      ...
      <div className="space-y-6 text-black text-[20px] font-poppins">
        ...
        <p>
          Learn more at{' '}
          <Link href="/demo" className="text-[#3754ED] underline">
            SmartTIX.com
          </Link>
        </p>
        ...
        <p>
          ...
          <Link
            href="https://www.businesswire.com/news/home/20250404071112/en/GeoPoint-Launches-SmartTIX-The-Most-Advanced-AI-Powered-Ticket-Management-Platform-for-Utility-Damage-Prevention"
