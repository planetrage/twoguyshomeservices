      ...
      <div className="pt-[60px] pb-[60px] bg-azure rounded-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
          ...
          <div className="flex justify-center md:justify-start px-4">
            <Link
              href="/demo"
              className="bg-[#6AEF5B] text-[#13144D] px-6 py-3 rounded-md shadow-md text-[18px] md:text-[24px] font-bold text-center hover:bg-[#5adc4d] transition w-full max-w-[280px]">
