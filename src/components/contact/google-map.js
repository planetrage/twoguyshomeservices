  ...
  return (
    <div className="custom-container py-12">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
        {/* Contact Info & Social */}
        <div className="space-y-2 text-[16px] md:text-[20px] text-[#13144D]">
          <h2 className="text-[24px] font-bold">SmartTIX</h2>
          <p>213 Hobbs Street</p>
          <p>Tampa, Florida 33619</p>
          <p>info@smarttix.com</p>
          <p className="pb-4">o: 813-851-9999</p>
          ...
          <div className="flex flex-wrap gap-4 pt-4">
            {[
              ...
              <span
                key={idx}
                className="w-12 h-12 rounded-full bg-[#22C763] flex items-center justify-center text-white text-xl hover:scale-105 transition"
                aria-label={label}
              >
                {icon}
              </span>
